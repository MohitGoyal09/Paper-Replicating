...
class SelfAttention(nn.Module):
    ...
    def __init__(self , args : ModelArgs):
        ...
        # Indicates the number of heads for the query
        self.n_heads_q = args.n_heads
        # Indicates how many times the key and Value Should be repeated
    ...
    def forward(self , x : torch.Tensor , start_pos : int , freq_complex : torch.Tensor):
        ...
        # (B , 1 , H_KV , Head_Dim) -> ( B , 1 , H_KV , Head_Dim)
        xk = apply_rotary_emb(xk , freq_complex , device = x.device)
...
class Transformer(nn.Module):
    ...
    def __init__(self , args : ModelArgs):
        ...
        self.output = nn.Linear(args.dim , self.args.vocab_size , bias=False)
